...
class ResPartner(models.Model):
    ...
    # def check_vat_uniq(self):
    #     if self.same_vat_partner_id:
    #         for sp in self.same_vat_partner_id:
    #             if sp.company_type == 'company' and self.company_type == 'company':
    #                 if self.branch:
    #                     if self.branch == sp.branch:
    #                         raise ValidationError(_('Please do not enter the same TAX ID.'))
    #             else:
    #                 raise ValidationError(_('Please do not enter the same TAX ID.'))
    ...
    def _compute_name(self):
        for rec in self:
            ...
            if rec.name_company and (prefix and prefix in rec.name_company) and (suffix and suffix in rec.name_company):
                return
