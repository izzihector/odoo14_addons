odoo.define("l10n_th_tax_report_backend.tax_report", function (require) {
    "use strict";
    ...
    var report_backend = AbstractAction.extend({
        ...
        events: {
            "click .o_l10n_th_tax_report_print_thai": "print_thai",
    ...
    core.action_registry.add("tax_report", report_backend);
