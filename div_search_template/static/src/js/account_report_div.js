odoo.define('div_search_template.account_report', function (require) {
'use strict';
...
var accountReportsWidget = AbstractAction.extend({
    ...
    render_searchview_buttons: function() {
        ...
        _.each(this.$searchview_buttons.find('.js_account_report_choice_filter'), function(k) {
         ...
         _.each(this.$searchview_buttons.find('.js_account_report_choice_filter_div_1'), function(k) {
            $(k).toggleClass('selected', (_.filter(self.report_options[$(k).data('filter')], function(el){return ''+el.id == ''+$(k).data('id') && el.selected === true;})).length > 0);
        });
        ...
        this.$searchview_buttons.find('.js_account_report_choice_filter').click(function (event) {
            ...
            _.filter(self.report_options[option_value], function(el) {
                if (''+el.id == ''+option_id){
                    if (el.selected === undefined || el.selected === null){el.selected = true;}
           ...
           this.$searchview_buttons.find('.js_account_report_choice_filter_div_1').click(function (event) {
            var option_value = $(this).data('filter');
            var option_id = $(this).data('id');
            var div_total = self.actionManager.el.getElementsByClassName('o_account_report_column_value');
            var div_report = self.report_options[option_value]
            ...
            _.filter(self.report_options[option_value], function(el) {
                if (''+el.id == ''+option_id){
                    ...
                    if(div_report.length === 2){
                        if (div_report[0].selected === true) {
                            div_report[1].selected = false
                        }
                        if (div_report[1].selected === true) {
                            div_report[0].selected = false
                        }
                     }
                     if(div_report.length === 3){

                        if (div_report[0].selected === true) {
                            div_report[1].selected = false
                            div_report[2].selected = false
                        }
                        if (div_report[1].selected === true) {
                            div_report[2].selected = false
                            div_report[0].selected = false
                        }
                        if (div_report[2].selected === true) {
                            div_report[0].selected = false
                            div_report[1].selected = false
                        }
                       }
                      if(div_report.length === 4){

                        if (div_report[0].selected === true) {
                            div_report[1].selected = false
                            div_report[2].selected = false
                            div_report[3].selected = false
                        }
                        if (div_report[1].selected === true) {
                            div_report[0].selected = false
                            div_report[2].selected = false
                        ...
                        if (div_report[3].selected === true) {
                            div_report[0].selected = false
                            div_report[1].selected = false
                            div_report[2].selected = false
                        }
                       }
                      if(div_report.length === 5){

                        if (div_report[0].selected === true) {
                            div_report[1].selected = false
                            div_report[2].selected = false
                            div_report[3].selected = false
                            div_report[4].selected = false
                        }
                        if (div_report[1].selected === true) {
                            div_report[0].selected = false
                            div_report[2].selected = false
                       ...
                       if(div_report.length === 10){
                        ...
                        if (div_report[8].selected === true) {
                         ...
                         if (div_report[9].selected === true) {
                          ...
                          if (div_report[10].selected === true) {
                            div_report[0].selected = false
                            div_report[1].selected = false
                            div_report[2].selected = false
                            div_report[3].selected = false
        ...
        this.$searchview_buttons.find('.js_account_report_date_cmp_filter').click(function (event) {
            var hide = self.actionManager.el.getElementsByClassName('o_account_report_column_header');
//               for (let i = 0; i < hide.length; i++) {
//                   if(hide[i].innerText === '%'){
//                        console.log(hide[i].innerText);
//                   }
//                   if(hide[i].innerHTML === '%'){
//                         hide[i].display = 'none';
//
