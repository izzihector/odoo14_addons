        ...
        QUnit.test("mounted is called once when returning on 'Account Reports' from breadcrumb", async assert => {
            ...
            const actionManager = await createActionManager({
                ...
                mockRPC: function (route) {
                    if (route === '/web/dataset/call_kw/Balance_Sheet_thai/get_report_informations') {
                        return Promise.resolve({
                            options: {},
                            buttons: [],
                            main_html: '<a action="go_to_details">Go to detail view</a>',
                        });
                    } else if (route === '/web/dataset/call_kw/Balance_Sheet_thai/go_to_details') {
                        return Promise.resolve({
                    ...
                    } else if (route === '/web/dataset/call_kw/Balance_Sheet_thai/get_html_footnotes') {
                        return Promise.resolve("");
                    }
