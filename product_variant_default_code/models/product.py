...
def get_rendered_default_code(product, mask):
    ...
    # default_code = default_code + '-' + product.env['ir.sequence'].next_by_code('product.variant.seq')
...
class ProductProduct(models.Model):
    ...
    def create(self, vals):
        ...
        if product.reference_mask:
            render_default_code(product, product.product_tmpl_id._get_default_mask())
